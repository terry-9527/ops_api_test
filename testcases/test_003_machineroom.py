# -*- coding: utf-8 -*-
'''
@Time    : 2022/4/24 18:30
@Author  : Terry
@File    : test_003_machineroom.py
...
# 读取测试用例数据
cases = readData().read_excel("新建机房", "demo.xlsx")
req = HandleRequests()
myassert = MyAssert()
...
class TestMachineRoom:
    ...
    def test_new_machineroom(self, case, user_login):
        mylogger.info("=========== 新建机房接口测试  ===============")
...
if __name__ == '__main__':
    pytest.main(["-v", "-s"], "test_003_machineroom.py")
